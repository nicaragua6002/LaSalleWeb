...
namespace LaSalleWeb.Controllers
{
    ...
    public class DocentesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NombreCompleto,Email,INSS,SalarioBase")] Docente docente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NombreCompleto,Email,INSS,SalarioBase")] Docente docente)
        {
            if (ModelState.IsValid)
            {
